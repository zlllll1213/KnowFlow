...
func main() {
	...
	protected := r.Group("/")
	protected.Use(handler.RequireInternalToken(cfg.InternalToken))
	protected.POST("/rag/ask", h.Ask)
	protected.POST("/rag/ask/stream", h.AskStream)
	protected.POST("/agent/ask", h.AskAgent)
	protected.POST("/agent/ask/stream", h.AskAgentStream)
	protected.POST("/rag/agent/ask", h.AskAgent)
	protected.POST("/rag/agent/ask/stream", h.AskAgentStream)
